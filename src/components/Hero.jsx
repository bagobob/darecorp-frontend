    ...
    <div name="home" className='w-full h-screen bg-zinc-200 flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
            <div className='flex flex-col justify-center md:items-start w-full px-2 py-8'>
                <p className='text-2xl'>We can help you take a step ahead in your</p>
            ...
            <div >
                <img className="w-full" src={bagImg} alt="" />
            </div>
            ...
            border border-slate-300 rounded-xl text-center shadow-xl'>
                ...
                <div className='flex justify-between flex-wrap px-4'>
                    <p className='flex px-4 py-2 text-slate-500 cursor-pointer'><ServerIcon className='h-8 text-indigo-600   px-4 py-2 ' />
                    <Link activeClass="active" to="service" spy={true} smooth={true} offset={-50} duration={500}>Web Development</Link>
                    </p>
                    <p className='flex px-4 py-2 text-slate-500 cursor-pointer'><DatabaseIcon className='h-8 text-indigo-600  px-4 py-2' />
                         <Link activeClass="active" to="service" spy={true} smooth={true} offset={-50} duration={500}>Design</Link>
                    </p>
                    <p className='flex px-4 py-2 text-slate-500 cursor-pointer'><CloudUploadIcon className='h-8 text-indigo-600   px-4 py-2 ' />
                    <Link activeClass="active" to="service" spy={true} smooth={true} offset={-50} duration={500}>IT Consulting</Link>
                    </p>
                    <p className='flex px-4 py-2 text-slate-500 cursor-pointer'><PaperAirplaneIcon className='h-8 text-indigo-600  px-4 py-2' />
